...
export class UserResolverBase {
  ...
  async createUser(@graphql.Args() args: CreateUserArgs): Promise<User> {
    return await this.service.createUser({
      ...
      data: {
        ...
        personalIdInfo: args.data.personalIdInfo
          ? {
              connect: args.data.personalIdInfo,
            }
          : undefined,
      },
    });
  ...
  @graphql.ResolveField(() => PersonalIdInfo, {
    nullable: true,
    name: "personalIdInfo",
  })
  async getPersonalIdInfo(
    @graphql.Parent() parent: User
  ): Promise<PersonalIdInfo | null> {
    const result = await this.service.getPersonalIdInfo(parent.id);
